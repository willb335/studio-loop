  ...
  return (
    <div ref={tooltipRef} className="relative inline-block">
      <button
        ...
        onFocus={handleOpen}
        onBlur={handleClose}
        className="inline-flex items-center justify-center w-5 h-5 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-pink-400 focus:ring-offset-1 cursor-pointer"
